...
<body>
  <nav>
    ...
    <pre style="font-family: sans-serif;font-size:18px;text-transform: uppercase;text-align: center;font-family: sans-serif;">Hi,<?php echo ($_SESSION['username']);?>. Welcome to our site.</pre>
...
<div id="content">
  ...
  <?php
    while ($row = mysqli_fetch_array($result)) {
        ...
        echo "<p>Offered Price Rs: ".$row['price']."</p>";
        echo "<p><a href='order.php?id= $row[tbl_image_id]'><input type='submit' value='BUY'/></a></p>";
      echo "</div>";
    }
  ?>
</div>
